...
PROFILED_BIN = build/$(TARGET)_profiled
...
DEBUG_FLAG=-g3
PROFILED_FLAGS=-DPROFILING

all: debug release profiled
...
profiled: CXXFLAGS+=$(PROFILED_FLAGS)
...
$(PROFILED_BIN): $(OBJS) $(TEST)
	$(CXX) $(CXXFLAGS) $(CPPFLAGS) -o $(PROFILED_BIN) $(OBJS) $(TEST)
